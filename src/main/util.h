...
static unsigned short m64p_swap16(unsigned short x)
{
    #ifdef _MSC_VER
...
static unsigned int m64p_swap32(unsigned int x)
{
    #ifdef _MSC_VER
...
static unsigned long long int m64p_swap64(unsigned long long int x)
{
    #ifdef _MSC_VER
