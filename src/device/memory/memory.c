...
{
    *r4300_address() = virtual_to_physical_address(&g_dev.r4300, *r4300_address(),0);
    if (*r4300_address() == 0x00000000) return;
    read_word_in_memory();
}
...
{
    invalidate_r4300_cached_code(&g_dev.r4300, *r4300_address(), 4);
    *r4300_address() = virtual_to_physical_address(&g_dev.r4300, *r4300_address(),1);
    if (*r4300_address() == 0x00000000) return;
...
{
    invalidate_r4300_cached_code(&g_dev.r4300, *r4300_address(), 1);
    *r4300_address() = virtual_to_physical_address(&g_dev.r4300, *r4300_address(),1);
    if (*r4300_address() == 0x00000000) return;
...
{
    invalidate_r4300_cached_code(&g_dev.r4300, *r4300_address(), 2);
    *r4300_address() = virtual_to_physical_address(&g_dev.r4300, *r4300_address(),1);
    if (*r4300_address() == 0x00000000) return;
...
{
    invalidate_r4300_cached_code(&g_dev.r4300, *r4300_address(), 8);
    *r4300_address() = virtual_to_physical_address(&g_dev.r4300, *r4300_address(),1);
    if (*r4300_address() == 0x00000000) return;
...
{
    readw(read_rdram_dram, &g_dev.ri, *r4300_address(), g_dev.r4300.rdword);
}

void read_rdramb(void)
{
    readb(read_rdram_dram, &g_dev.ri, *r4300_address(), g_dev.r4300.rdword);
}

void read_rdramh(void)
{
    readh(read_rdram_dram, &g_dev.ri, *r4300_address(), g_dev.r4300.rdword);
}

void read_rdramd(void)
{
    readd(read_rdram_dram, &g_dev.ri, *r4300_address(), g_dev.r4300.rdword);
}

void write_rdram(void)
{
    writew(write_rdram_dram, &g_dev.ri, *r4300_address(), *r4300_wword());
}

void write_rdramb(void)
{
    writeb(write_rdram_dram, &g_dev.ri, *r4300_address(), *r4300_wbyte());
}

void write_rdramh(void)
{
    writeh(write_rdram_dram, &g_dev.ri, *r4300_address(), *r4300_whword());
}

void write_rdramd(void)
{
    writed(write_rdram_dram, &g_dev.ri, *r4300_address(), *r4300_wdword());
}


void read_rdramFB(void)
{
    readw(read_rdram_fb, &g_dev.dp, *r4300_address(), g_dev.r4300.rdword);
}

void read_rdramFBb(void)
{
    readb(read_rdram_fb, &g_dev.dp, *r4300_address(), g_dev.r4300.rdword);
}

void read_rdramFBh(void)
{
    readh(read_rdram_fb, &g_dev.dp, *r4300_address(), g_dev.r4300.rdword);
}

void read_rdramFBd(void)
{
    readd(read_rdram_fb, &g_dev.dp, *r4300_address(), g_dev.r4300.rdword);
}

void write_rdramFB(void)
{
    writew(write_rdram_fb, &g_dev.dp, *r4300_address(), *r4300_wword());
}

void write_rdramFBb(void)
{
    writeb(write_rdram_fb, &g_dev.dp, *r4300_address(), *r4300_wbyte());
}

void write_rdramFBh(void)
{
    writeh(write_rdram_fb, &g_dev.dp, *r4300_address(), *r4300_whword());
}

void write_rdramFBd(void)
{
    writed(write_rdram_fb, &g_dev.dp, *r4300_address(), *r4300_wdword());
}


static void read_rdramreg(void)
{
    readw(read_rdram_regs, &g_dev.ri, *r4300_address(), g_dev.r4300.rdword);
}

static void read_rdramregb(void)
{
    readb(read_rdram_regs, &g_dev.ri, *r4300_address(), g_dev.r4300.rdword);
}

static void read_rdramregh(void)
{
    readh(read_rdram_regs, &g_dev.ri, *r4300_address(), g_dev.r4300.rdword);
}

static void read_rdramregd(void)
{
    readd(read_rdram_regs, &g_dev.ri, *r4300_address(), g_dev.r4300.rdword);
}

static void write_rdramreg(void)
{
    writew(write_rdram_regs, &g_dev.ri, *r4300_address(), *r4300_wword());
}

static void write_rdramregb(void)
{
    writeb(write_rdram_regs, &g_dev.ri, *r4300_address(), *r4300_wbyte());
}

static void write_rdramregh(void)
{
    writeh(write_rdram_regs, &g_dev.ri, *r4300_address(), *r4300_whword());
}

static void write_rdramregd(void)
{
    writed(write_rdram_regs, &g_dev.ri, *r4300_address(), *r4300_wdword());
}


static void read_rspmem(void)
{
    readw(read_rsp_mem, &g_dev.sp, *r4300_address(), g_dev.r4300.rdword);
}

static void read_rspmemb(void)
{
    readb(read_rsp_mem, &g_dev.sp, *r4300_address(), g_dev.r4300.rdword);
}

static void read_rspmemh(void)
{
    readh(read_rsp_mem, &g_dev.sp, *r4300_address(), g_dev.r4300.rdword);
}

static void read_rspmemd(void)
{
    readd(read_rsp_mem, &g_dev.sp, *r4300_address(), g_dev.r4300.rdword);
}

static void write_rspmem(void)
{
    writew(write_rsp_mem, &g_dev.sp, *r4300_address(), *r4300_wword());
}

static void write_rspmemb(void)
{
    writeb(write_rsp_mem, &g_dev.sp, *r4300_address(), *r4300_wbyte());
}

static void write_rspmemh(void)
{
    writeh(write_rsp_mem, &g_dev.sp, *r4300_address(), *r4300_whword());
}

static void write_rspmemd(void)
{
    writed(write_rsp_mem, &g_dev.sp, *r4300_address(), *r4300_wdword());
}


static void read_rspreg(void)
{
    readw(read_rsp_regs, &g_dev.sp, *r4300_address(), g_dev.r4300.rdword);
}

static void read_rspregb(void)
{
    readb(read_rsp_regs, &g_dev.sp, *r4300_address(), g_dev.r4300.rdword);
}

static void read_rspregh(void)
{
    readh(read_rsp_regs, &g_dev.sp, *r4300_address(), g_dev.r4300.rdword);
}

static void read_rspregd(void)
{
    readd(read_rsp_regs, &g_dev.sp, *r4300_address(), g_dev.r4300.rdword);
}

static void write_rspreg(void)
{
    writew(write_rsp_regs, &g_dev.sp, *r4300_address(), *r4300_wword());
}

static void write_rspregb(void)
{
    writeb(write_rsp_regs, &g_dev.sp, *r4300_address(), *r4300_wbyte());
}

static void write_rspregh(void)
{
    writeh(write_rsp_regs, &g_dev.sp, *r4300_address(), *r4300_whword());
}

static void write_rspregd(void)
{
    writed(write_rsp_regs, &g_dev.sp, *r4300_address(), *r4300_wdword());
}


static void read_rspreg2(void)
{
    readw(read_rsp_regs2, &g_dev.sp, *r4300_address(), g_dev.r4300.rdword);
}

static void read_rspreg2b(void)
{
    readb(read_rsp_regs2, &g_dev.sp, *r4300_address(), g_dev.r4300.rdword);
}

static void read_rspreg2h(void)
{
    readh(read_rsp_regs2, &g_dev.sp, *r4300_address(), g_dev.r4300.rdword);
}

static void read_rspreg2d(void)
{
    readd(read_rsp_regs2, &g_dev.sp, *r4300_address(), g_dev.r4300.rdword);
}

static void write_rspreg2(void)
{
    writew(write_rsp_regs2, &g_dev.sp, *r4300_address(), *r4300_wword());
}

static void write_rspreg2b(void)
{
    writeb(write_rsp_regs2, &g_dev.sp, *r4300_address(), *r4300_wbyte());
}

static void write_rspreg2h(void)
{
    writeh(write_rsp_regs2, &g_dev.sp, *r4300_address(), *r4300_whword());
}

static void write_rspreg2d(void)
{
    writed(write_rsp_regs2, &g_dev.sp, *r4300_address(), *r4300_wdword());
}


static void read_dp(void)
{
    readw(read_dpc_regs, &g_dev.dp, *r4300_address(), g_dev.r4300.rdword);
}

static void read_dpb(void)
{
    readb(read_dpc_regs, &g_dev.dp, *r4300_address(), g_dev.r4300.rdword);
}

static void read_dph(void)
{
    readh(read_dpc_regs, &g_dev.dp, *r4300_address(), g_dev.r4300.rdword);
}

static void read_dpd(void)
{
    readd(read_dpc_regs, &g_dev.dp, *r4300_address(), g_dev.r4300.rdword);
}

static void write_dp(void)
{
    writew(write_dpc_regs, &g_dev.dp, *r4300_address(), *r4300_wword());
}

static void write_dpb(void)
{
    writeb(write_dpc_regs, &g_dev.dp, *r4300_address(), *r4300_wbyte());
}

static void write_dph(void)
{
    writeh(write_dpc_regs, &g_dev.dp, *r4300_address(), *r4300_whword());
}

static void write_dpd(void)
{
    writed(write_dpc_regs, &g_dev.dp, *r4300_address(), *r4300_wdword());
}


static void read_dps(void)
{
    readw(read_dps_regs, &g_dev.dp, *r4300_address(), g_dev.r4300.rdword);
}

static void read_dpsb(void)
{
    readb(read_dps_regs, &g_dev.dp, *r4300_address(), g_dev.r4300.rdword);
}

static void read_dpsh(void)
{
    readh(read_dps_regs, &g_dev.dp, *r4300_address(), g_dev.r4300.rdword);
}

static void read_dpsd(void)
{
    readd(read_dps_regs, &g_dev.dp, *r4300_address(), g_dev.r4300.rdword);
}

static void write_dps(void)
{
    writew(write_dps_regs, &g_dev.dp, *r4300_address(), *r4300_wword());
}

static void write_dpsb(void)
{
    writeb(write_dps_regs, &g_dev.dp, *r4300_address(), *r4300_wbyte());
}

static void write_dpsh(void)
{
    writeh(write_dps_regs, &g_dev.dp, *r4300_address(), *r4300_whword());
}

static void write_dpsd(void)
{
    writed(write_dps_regs, &g_dev.dp, *r4300_address(), *r4300_wdword());
}


static void read_mi(void)
{
    readw(read_mi_regs, &g_dev.r4300, *r4300_address(), g_dev.r4300.rdword);
}

static void read_mib(void)
{
    readb(read_mi_regs, &g_dev.r4300, *r4300_address(), g_dev.r4300.rdword);
}

static void read_mih(void)
{
    readh(read_mi_regs, &g_dev.r4300, *r4300_address(), g_dev.r4300.rdword);
}

static void read_mid(void)
{
    readd(read_mi_regs, &g_dev.r4300, *r4300_address(), g_dev.r4300.rdword);
}

void write_mi(void)
{
    writew(write_mi_regs, &g_dev.r4300, *r4300_address(), *r4300_wword());
}

void write_mib(void)
{
    writeb(write_mi_regs, &g_dev.r4300, *r4300_address(), *r4300_wbyte());
}

void write_mih(void)
{
    writeh(write_mi_regs, &g_dev.r4300, *r4300_address(), *r4300_whword());
}

void write_mid(void)
{
    writed(write_mi_regs, &g_dev.r4300, *r4300_address(), *r4300_wdword());
}


static void read_vi(void)
{
    readw(read_vi_regs, &g_dev.vi, *r4300_address(), g_dev.r4300.rdword);
}

static void read_vib(void)
{
    readb(read_vi_regs, &g_dev.vi, *r4300_address(), g_dev.r4300.rdword);
}

static void read_vih(void)
{
    readh(read_vi_regs, &g_dev.vi, *r4300_address(), g_dev.r4300.rdword);
}

static void read_vid(void)
{
    readd(read_vi_regs, &g_dev.vi, *r4300_address(), g_dev.r4300.rdword);
}

static void write_vi(void)
{
    writew(write_vi_regs, &g_dev.vi, *r4300_address(), *r4300_wword());
}

static void write_vib(void)
{
    writeb(write_vi_regs, &g_dev.vi, *r4300_address(), *r4300_wbyte());
}

static void write_vih(void)
{
    writeh(write_vi_regs, &g_dev.vi, *r4300_address(), *r4300_whword());
}

static void write_vid(void)
{
    writed(write_vi_regs, &g_dev.vi, *r4300_address(), *r4300_wdword());
}


static void read_ai(void)
{
    readw(read_ai_regs, &g_dev.ai, *r4300_address(), g_dev.r4300.rdword);
}

static void read_aib(void)
{
    readb(read_ai_regs, &g_dev.ai, *r4300_address(), g_dev.r4300.rdword);
}

static void read_aih(void)
{
    readh(read_ai_regs, &g_dev.ai, *r4300_address(), g_dev.r4300.rdword);
}

static void read_aid(void)
{
    readd(read_ai_regs, &g_dev.ai, *r4300_address(), g_dev.r4300.rdword);
}

static void write_ai(void)
{
    writew(write_ai_regs, &g_dev.ai, *r4300_address(), *r4300_wword());
}

static void write_aib(void)
{
    writeb(write_ai_regs, &g_dev.ai, *r4300_address(), *r4300_wbyte());
}

static void write_aih(void)
{
    writeh(write_ai_regs, &g_dev.ai, *r4300_address(), *r4300_whword());
}

static void write_aid(void)
{
    writed(write_ai_regs, &g_dev.ai, *r4300_address(), *r4300_wdword());
}


static void read_pi(void)
{
    readw(read_pi_regs, &g_dev.pi, *r4300_address(), g_dev.r4300.rdword);
}

static void read_pib(void)
{
    readb(read_pi_regs, &g_dev.pi, *r4300_address(), g_dev.r4300.rdword);
}

static void read_pih(void)
{
    readh(read_pi_regs, &g_dev.pi, *r4300_address(), g_dev.r4300.rdword);
}

static void read_pid(void)
{
    readd(read_pi_regs, &g_dev.pi, *r4300_address(), g_dev.r4300.rdword);
}

static void write_pi(void)
{
    writew(write_pi_regs, &g_dev.pi, *r4300_address(), *r4300_wword());
}

static void write_pib(void)
{
    writeb(write_pi_regs, &g_dev.pi, *r4300_address(), *r4300_wbyte());
}

static void write_pih(void)
{
    writeh(write_pi_regs, &g_dev.pi, *r4300_address(), *r4300_whword());
}

static void write_pid(void)
{
    writed(write_pi_regs, &g_dev.pi, *r4300_address(), *r4300_wdword());
}


static void read_ri(void)
{
    readw(read_ri_regs, &g_dev.ri, *r4300_address(), g_dev.r4300.rdword);
}

static void read_rib(void)
{
    readb(read_ri_regs, &g_dev.ri, *r4300_address(), g_dev.r4300.rdword);
}

static void read_rih(void)
{
    readh(read_ri_regs, &g_dev.ri, *r4300_address(), g_dev.r4300.rdword);
}

static void read_rid(void)
{
    readd(read_ri_regs, &g_dev.ri, *r4300_address(), g_dev.r4300.rdword);
}

static void write_ri(void)
{
    writew(write_ri_regs, &g_dev.ri, *r4300_address(), *r4300_wword());
}

static void write_rib(void)
{
    writeb(write_ri_regs, &g_dev.ri, *r4300_address(), *r4300_wbyte());
}

static void write_rih(void)
{
    writeh(write_ri_regs, &g_dev.ri, *r4300_address(), *r4300_whword());
}

static void write_rid(void)
{
    writed(write_ri_regs, &g_dev.ri, *r4300_address(), *r4300_wdword());
}


static void read_si(void)
{
    readw(read_si_regs, &g_dev.si, *r4300_address(), g_dev.r4300.rdword);
}

static void read_sib(void)
{
    readb(read_si_regs, &g_dev.si, *r4300_address(), g_dev.r4300.rdword);
}

static void read_sih(void)
{
    readh(read_si_regs, &g_dev.si, *r4300_address(), g_dev.r4300.rdword);
}

static void read_sid(void)
{
    readd(read_si_regs, &g_dev.si, *r4300_address(), g_dev.r4300.rdword);
}

static void write_si(void)
{
    writew(write_si_regs, &g_dev.si, *r4300_address(), *r4300_wword());
}

static void write_sib(void)
{
    writeb(write_si_regs, &g_dev.si, *r4300_address(), *r4300_wbyte());
}

static void write_sih(void)
{
    writeh(write_si_regs, &g_dev.si, *r4300_address(), *r4300_whword());
}

static void write_sid(void)
{
    writed(write_si_regs, &g_dev.si, *r4300_address(), *r4300_wdword());
}

static void read_pi_flashram_status(void)
{
    readw(read_flashram_status, &g_dev.pi, *r4300_address(), g_dev.r4300.rdword);
}

static void read_pi_flashram_statusb(void)
{
    readb(read_flashram_status, &g_dev.pi, *r4300_address(), g_dev.r4300.rdword);
}

static void read_pi_flashram_statush(void)
{
    readh(read_flashram_status, &g_dev.pi, *r4300_address(), g_dev.r4300.rdword);
}

static void read_pi_flashram_statusd(void)
{
    readd(read_flashram_status, &g_dev.pi, *r4300_address(), g_dev.r4300.rdword);
}

static void write_pi_flashram_command(void)
{
    writew(write_flashram_command, &g_dev.pi, *r4300_address(), *r4300_wword());
}

static void write_pi_flashram_commandb(void)
{
    writeb(write_flashram_command, &g_dev.pi, *r4300_address(), *r4300_wbyte());
}

static void write_pi_flashram_commandh(void)
{
    writeh(write_flashram_command, &g_dev.pi, *r4300_address(), *r4300_whword());
}

static void write_pi_flashram_commandd(void)
{
    writed(write_flashram_command, &g_dev.pi, *r4300_address(), *r4300_wdword());
}


static void read_rom(void)
{
    readw(read_cart_rom, &g_dev.pi, *r4300_address(), g_dev.r4300.rdword);
}

static void read_romb(void)
{
    readb(read_cart_rom, &g_dev.pi, *r4300_address(), g_dev.r4300.rdword);
}

static void read_romh(void)
{
    readh(read_cart_rom, &g_dev.pi, *r4300_address(), g_dev.r4300.rdword);
}

static void read_romd(void)
{
    readd(read_cart_rom, &g_dev.pi, *r4300_address(), g_dev.r4300.rdword);
}

static void write_rom(void)
{
    writew(write_cart_rom, &g_dev.pi, *r4300_address(), *r4300_wword());
}


static void read_pif(void)
{
    readw(read_pif_ram, &g_dev.si, *r4300_address(), g_dev.r4300.rdword);
}

static void read_pifb(void)
{
    readb(read_pif_ram, &g_dev.si, *r4300_address(), g_dev.r4300.rdword);
}

static void read_pifh(void)
{
    readh(read_pif_ram, &g_dev.si, *r4300_address(), g_dev.r4300.rdword);
}

static void read_pifd(void)
{
    readd(read_pif_ram, &g_dev.si, *r4300_address(), g_dev.r4300.rdword);
}

static void write_pif(void)
{
    writew(write_pif_ram, &g_dev.si, *r4300_address(), *r4300_wword());
}

static void write_pifb(void)
{
    writeb(write_pif_ram, &g_dev.si, *r4300_address(), *r4300_wbyte());
}

static void write_pifh(void)
{
    writeh(write_pif_ram, &g_dev.si, *r4300_address(), *r4300_whword());
}

static void write_pifd(void)
{
    writed(write_pif_ram, &g_dev.si, *r4300_address(), *r4300_wdword());
}
...
{
    readw(read_dd_regs, NULL, *r4300_address(), g_dev.r4300.rdword);
}

static void read_ddb(void)
{
    readb(read_dd_regs, NULL, *r4300_address(), g_dev.r4300.rdword);
}

static void read_ddh(void)
{
    readh(read_dd_regs, NULL, *r4300_address(), g_dev.r4300.rdword);
}

static void read_ddd(void)
{
    readd(read_dd_regs, NULL, *r4300_address(), g_dev.r4300.rdword);
}

static void write_dd(void)
{
    writew(write_dd_regs, NULL, *r4300_address(), *r4300_wword());
}

static void write_ddb(void)
{
    writeb(write_dd_regs, NULL, *r4300_address(), *r4300_wbyte());
}

static void write_ddh(void)
{
    writeh(write_dd_regs, NULL, *r4300_address(), *r4300_whword());
}

static void write_ddd(void)
{
    writed(write_dd_regs, NULL, *r4300_address(), *r4300_wdword());
}

#ifdef DBG
static void readmemb_with_bp_checks(void)
{
    check_breakpoints_on_mem_access(*r4300_pc(&g_dev.r4300)-0x4, *r4300_address(), 1,
            M64P_BKP_FLAG_ENABLED | M64P_BKP_FLAG_READ);

    g_dev.mem.saved_readmemb[*r4300_address()>>16]();
}

static void readmemh_with_bp_checks(void)
{
    check_breakpoints_on_mem_access(*r4300_pc(&g_dev.r4300)-0x4, *r4300_address(), 2,
            M64P_BKP_FLAG_ENABLED | M64P_BKP_FLAG_READ);

    g_dev.mem.saved_readmemh[*r4300_address()>>16]();
}

static void readmem_with_bp_checks(void)
{
    check_breakpoints_on_mem_access(*r4300_pc(&g_dev.r4300)-0x4, *r4300_address(), 4,
            M64P_BKP_FLAG_ENABLED | M64P_BKP_FLAG_READ);

    g_dev.mem.saved_readmem[*r4300_address()>>16]();
}

static void readmemd_with_bp_checks(void)
{
    check_breakpoints_on_mem_access(*r4300_pc(&g_dev.r4300)-0x4, *r4300_address(), 8,
            M64P_BKP_FLAG_ENABLED | M64P_BKP_FLAG_READ);

    g_dev.mem.saved_readmemd[*r4300_address()>>16]();
}
...
static void writememb_with_bp_checks(void)
{
    ...
    return g_dev.mem.saved_writememb[*r4300_address()>>16]();
}
...
static void writememh_with_bp_checks(void)
{
    ...
    return g_dev.mem.saved_writememh[*r4300_address()>>16]();
}
...
static void writemem_with_bp_checks(void)
{
    ...
    return g_dev.mem.saved_writemem[*r4300_address()>>16]();
}
...
static void writememd_with_bp_checks(void)
{
    ...
    return g_dev.mem.saved_writememd[*r4300_address()>>16]();
}
