...
void gencallinterp(unsigned long addr, int jump)
{
   ...
   if (jump)
     mov_m32abs_imm32((unsigned int*)(&dyna_interp), 1);
   ...
   if (jump)
   {
     mov_m32abs_imm32((unsigned int*)(&dyna_interp), 0);
...
void gencheck_interupt_reg(void) // addr is in EAX
{
   ...
   mov_m32abs_reg32((unsigned int*)(&fake_instr.addr), EAX);
   mov_reg64_imm64(RAX, (unsigned long long) (&fake_instr));
   mov_m64abs_reg64((unsigned long long *)(&PC), RAX);
   mov_reg64_imm64(RAX, (unsigned long long) gen_interupt);
   call_reg64(RAX);
...
void genj(void)
{
   ...
   mov_m32abs_imm32((void*)(&last_addr), naddr);
...
void genj_out(void)
{
   ...
   mov_m32abs_imm32(&jump_to_address, naddr);
   mov_reg64_imm64(RAX, (unsigned long long) (dst+1));
   mov_m64abs_reg64((unsigned long long *)(&PC), RAX);
...
void genjal(void)
{
   ...
   mov_m32abs_imm32((unsigned int *)(reg + 31), dst->addr + 4);
...
void genlwc1(void)
{
   ...
   mov_reg32_m32abs(EAX, (unsigned int *)(&reg[dst->f.lf.base]));
   ...
   mov_m64abs_reg64((unsigned long long *)(&PC), RAX); // 8
   mov_m32abs_reg32((unsigned int *)(&address), EBX); // 7
   mov_reg64_m64abs(RDX, (unsigned long long *)(&reg_cop1_simple[dst->f.lf.ft])); // 8
   ...
   mov_reg64_m64abs(RBX, (unsigned long long *)(&reg_cop1_simple[dst->f.lf.ft])); // 8
...
void genldc1(void)
{
   ...
   mov_m64abs_reg64((unsigned long long *)(&PC), RAX); // 8
   mov_m32abs_reg32((unsigned int *)(&address), EBX); // 7
   mov_reg64_m64abs(RDX, (unsigned long long *)(&reg_cop1_double[dst->f.lf.ft])); // 8
   mov_m64abs_reg64((unsigned long long *)(&rdword), RDX); // 8
   shr_reg32_imm8(EBX, 16); // 3
   mov_reg64_preg64x8preg64(RBX, RBX, RSI);  // 4
   call_reg64(RBX); // 2
   ...
   mov_reg64_m64abs(RBX, (unsigned long long *)(&reg_cop1_double[dst->f.lf.ft])); // 8
...
void genswc1(void)
{
   ...
   mov_reg64_m64abs(RDX, (unsigned long long *)(&reg_cop1_simple[dst->f.lf.ft]));
...
void gensdc1(void)
{
   ...
   mov_reg64_m64abs(RSI, (unsigned long long *)(&reg_cop1_double[dst->f.lf.ft]));
