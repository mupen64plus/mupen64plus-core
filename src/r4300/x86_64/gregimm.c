...
{
   int r31_64bit = is64((unsigned int*)&g_dev.r4300.regs[31]);
   
   if (r31_64bit == 0)
     {
    int r31 = allocate_register_32_w((unsigned int *)&g_dev.r4300.regs[31]);
    
    mov_reg32_imm32(r31, g_dev.r4300.recomp.dst->addr+8);
     }
   else if (r31_64bit == -1)
     {
    mov_m32rel_imm32((unsigned int *)&g_dev.r4300.regs[31], g_dev.r4300.recomp.dst->addr + 8);
    if (g_dev.r4300.recomp.dst->addr & 0x80000000)
     ...
     {
    int r31 = allocate_register_64_w((unsigned long long *)&g_dev.r4300.regs[31]);
