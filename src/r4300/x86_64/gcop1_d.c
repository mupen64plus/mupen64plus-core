...
void genadd_d(void)
{
   ...
   mov_xreg64_m64rel(RAX, (unsigned long long *)(&g_dev.r4300.cp1.regs_double[g_dev.r4300.recomp.dst->f.cf.fs]));
   fld_preg64_qword(RAX);
   mov_xreg64_m64rel(RAX, (unsigned long long *)(&g_dev.r4300.cp1.regs_double[g_dev.r4300.recomp.dst->f.cf.ft]));
...
#else
   gencheck_cop1_unusable();
   and_m32rel_imm32((unsigned int*)&g_dev.r4300.cp1.fcr31, ~0x800000);
#endif
}
...
void genc_un_d(void)
{
   ...
   ffree_fpreg(0);
   jp_rj(13);
   and_m32rel_imm32((unsigned int*)&g_dev.r4300.cp1.fcr31, ~0x800000); // 11
   jmp_imm_short(11); // 2
   or_m32rel_imm32((unsigned int*)&g_dev.r4300.cp1.fcr31, 0x800000); // 11
#endif
}
