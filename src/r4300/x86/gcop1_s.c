...
void genadd_s(void)
{
   ...
   mov_eax_memoffs32((unsigned int *)(&g_dev.r4300.cp1.regs_simple[g_dev.r4300.recomp.dst->f.cf.fs]));
   fld_preg32_dword(EAX);
   mov_eax_memoffs32((unsigned int *)(&g_dev.r4300.cp1.regs_simple[g_dev.r4300.recomp.dst->f.cf.ft]));
