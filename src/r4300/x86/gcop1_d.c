...
void genadd_d(void)
{
   ...
   mov_eax_memoffs32((unsigned int *)(&g_dev.r4300.cp1.regs_double[g_dev.r4300.recomp.dst->f.cf.fs]));
   fld_preg32_qword(EAX);
   mov_eax_memoffs32((unsigned int *)(&g_dev.r4300.cp1.regs_double[g_dev.r4300.recomp.dst->f.cf.ft]));
   fadd_preg32_qword(EAX);
   mov_eax_memoffs32((unsigned int *)(&g_dev.r4300.cp1.regs_double[g_dev.r4300.recomp.dst->f.cf.fd]));
...
void genround_w_d(void)
{
   ...
   mov_eax_memoffs32((unsigned int*)(&g_dev.r4300.cp1.regs_double[g_dev.r4300.recomp.dst->f.cf.fs]));
   fld_preg32_qword(EAX);
   mov_eax_memoffs32((unsigned int*)(&g_dev.r4300.cp1.regs_simple[g_dev.r4300.recomp.dst->f.cf.fd]));
...
#else
   gencheck_cop1_unusable();
   and_m32_imm32((unsigned int*)&g_dev.r4300.cp1.fcr31, ~0x800000);
#endif
}
...
void genc_un_d(void)
{
   ...
   ffree_fpreg(0);
   jp_rj(12);
   and_m32_imm32((unsigned int*)&g_dev.r4300.cp1.fcr31, ~0x800000); // 10
   jmp_imm_short(10); // 2
   or_m32_imm32((unsigned int*)&g_dev.r4300.cp1.fcr31, 0x800000); // 10
#endif
}
