...
void emit_extjump2(int addr, int target, int linker)
{
  u_char *ptr=(u_char *)addr;
  assert((ptr[3]&0x0e)==0xa);
...
void emit_extjump_ds(int addr, int target)
{
...
void inline_readstub(int type, int i, u_int addr, signed char regmap[], int target, int adj, u_int reglist)
{
...
void inline_writestub(int type, int i, u_int addr, signed char regmap[], int target, int adj, u_int reglist)
{
...
void do_tlb_w_branch(int map, int c, u_int addr, int *jaddr)
{
...
void gen_orig_addr_w(int ar, int map) {
  if(map>=0) {
...
void generate_map_const(u_int addr,int reg) {
