...
{
   g_dev.r4300.recomp.dst->f.i.rs = g_dev.r4300.regs + ((g_dev.r4300.recomp.src >> 21) & 0x1F);
   g_dev.r4300.recomp.dst->f.i.rt = g_dev.r4300.regs + ((g_dev.r4300.recomp.src >> 16) & 0x1F);
...
{
   g_dev.r4300.recomp.dst->f.r.rs = g_dev.r4300.regs + ((g_dev.r4300.recomp.src >> 21) & 0x1F);
   g_dev.r4300.recomp.dst->f.r.rt = g_dev.r4300.regs + ((g_dev.r4300.recomp.src >> 16) & 0x1F);
   g_dev.r4300.recomp.dst->f.r.rd = g_dev.r4300.regs + ((g_dev.r4300.recomp.src >> 11) & 0x1F);
...
static void RSLL(void)
{
   ...
   if (g_dev.r4300.recomp.dst->f.r.rd == g_dev.r4300.regs) RNOP();
}
...
static void RMFC0(void)
{
   ...
   recompile_standard_r_type();
   g_dev.r4300.recomp.dst->f.r.rd = (int64_t*) (g_dev.r4300.cp0.regs + ((g_dev.r4300.recomp.src >> 11) & 0x1F));
   g_dev.r4300.recomp.dst->f.r.nrd = (g_dev.r4300.recomp.src >> 11) & 0x1F;
   if (g_dev.r4300.recomp.dst->f.r.rt == g_dev.r4300.regs) RNOP();
}
...
static void RADDI(void)
{
   ...
   recompile_standard_i_type();
   if(g_dev.r4300.recomp.dst->f.i.rt == g_dev.r4300.regs) RNOP();
}
