...
static void osd_init(int width, int height)
{
}
...
static osd_message_t * osd_new_message(enum osd_corner eCorner, const char *fmt, ...)
{
	return NULL;
}

static void osd_update_message(osd_message_t *msg, const char *fmt, ...)
{
}

static void osd_delete_message(osd_message_t *msg)
{
}

static void osd_message_set_static(osd_message_t *msg)
{
}

static void osd_message_set_user_managed(osd_message_t *msg)
{
}
